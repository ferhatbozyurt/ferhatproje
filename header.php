...
$soforsor=$db->prepare("SELECT * FROM sofor where sofor_mail=:mail");
$soforsor->execute(array(
'mail' => $_SESSION['sofor_mail']
));

$say=$soforsor->rowCount();
...
<head><script src="https://cdn.ckeditor.com/4.14.0/standard/ckeditor.js"></script></head>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-taxi"></i> <span>KuşadasıTransfer</span></a>
          </div>
          ...
          <div class="profile clearfix">
            ...
            <div class="profile_info">
              <span>Hoşgeldin</span>
              <h2><?php echo $soforcek['sofor_adsoyad'] ?></h2>
            </div>
          </div>
          <!-- /menu profile quick info -->
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a href="sofor.php"><i class="fa fa-home"></i> ŞOFOR İŞLEMLERİ </a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="https://seeklogo.com/images/L/los-angeles-lakers-nba-logo-D303ACAC63-seeklogo.com.png" alt=""><?php echo $soforcek['sofor_ad']; ?>
