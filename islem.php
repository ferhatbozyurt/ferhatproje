...
if (isset($_POST['rezervasyonduzenle'])) {

  $rez_id=$_POST['rez_id'];

  $ayarkaydet=$db->prepare("UPDATE rezervasyon SET
    rez_nereden=:rez_nereden,
    rez_nereye=:rez_nereye,
    rez_tarih=:rez_tarih,
    rez_saat=:rez_saat,
    rez_kullanici=:rez_kullanici,
    rez_sofor=:rez_sofor,
    rez_arac=:rez_arac,
    rez_mazeret=:rez_mazeret

    WHERE rez_id={$_POST['rez_id']}");

  $update=$ayarkaydet->execute(array(
    'rez_nereden' => $_POST['rez_nereden'],
    'rez_nereye' => $_POST['rez_nereye'],
    'rez_tarih' => $_POST['rez_tarih'],
    'rez_saat' => $_POST['rez_saat'],
    'rez_kullanici' => $_POST['rez_kullanici'],
    'rez_sofor' => $_POST['rez_sofor'],
    'rez_arac' => $_POST['rez_arac'],
    'rez_mazeret' => $_POST['rez_mazeret']
  ));


  if ($update) {

    Header("Location:../production/rezervasyon-duzenle.php?rez_id=$rez_id&durum=ok");

  } else {

    Header("Location:../production/rezervasyon-duzenle.php?rez_id=$rez_id&durum=no");
  }
